...
import { Search, Menu, X, User, Globe, Mic, ChevronDown} from "lucide-react";
            ...
            <div className="hidden sm:flex items-center gap-4">
              ...
              <div className="relative" ref={menuRef}>
                <button
                  ...
                  className="p-2 rounded-full hover:bg-blue-100 transition flex items-center gap-1"
                  title={t("profile")}>
                  <User size={20} />
                  <ChevronDown size={16} />
                </button>
                  ...
                  {showProfileMenu && (
                    <motion.div
                      ...
                      <button
                        ...
                        className="block w-full text-left px-4 py-2 text-blue-600 hover:bg-blue-100 transition">
                        {t("instructor")}
                      </button>
                      <button
                        onClick={() => {
                        ...
                        className="block w-full text-left px-4 py-2 text-green-600 hover:bg-green-100 transition">
                        {t("learner")}
                      </button>
                    </motion.div>
                  )}
        ...
        {isSidebarOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 w-64 h-full bg-white shadow-xl z-50 flex flex-col p-6">
              ...
              <nav className="flex flex-col gap-3">
                ...
                <div className="mt-4">
                  <button
                    onClick={() =>
                      setShowSidebarProfileMenu(!showSidebarProfileMenu)
                    }
                    className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition w-full">
                    <User size={18} />
                    <span>{t("profile")}</span>
                    <ChevronDown
                      size={16}
                      className={`ml-auto transition-transform ${
                        showSidebarProfileMenu ? "rotate-180" : ""
                      }`}/>
                  </button>
                    ...
                    {showSidebarProfileMenu && (
                      <motion.div
                        ...
                        <button
                          ...
                          className="text-blue-600 text-left hover:bg-blue-100 rounded-md px-2 py-1 transition">
                          {t("instructor")}
                        </button>
                        <button
                          onClick={() => {
                          ...
                          className="text-green-600 text-left hover:bg-green-100 rounded-md px-2 py-1 transition">
                          {t("learner")}
                        </button>
                      </motion.div>
                    )}
                ...
                <button
                  ...
                  className="mt-4 flex items-center gap-2 text-gray-700 hover:text-blue-600 transition w-full">
                  <Globe size={18} />
