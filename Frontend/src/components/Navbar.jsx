    ...
    <div className="w-full bg-gray-300">
      <div className="flex justify-between items-center py-4 px-6 sm:px-12 xl:px-24">
        ...
        <div className="flex items-center gap-3">
          <button className="sm:hidden p-2 rounded-full hover:bg-gray-200" onClick={() => setShowSearch(!showSearch)}>
            <Search size={20} />
          </button>
          ...
          <div className="hidden sm:flex items-center gap-2 sm:gap-4">
            ...
            <Link to="/login" className="px-3 py-2 rounded-full text-sm text-black hover:bg-gray-200">
              Login
            </Link>
          </div>
        </div>
