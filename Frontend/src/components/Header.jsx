  ...
  return (
    <div className="w-full bg-yellow-100 py-20 flex items-center justify-center">
      <div className="mx-8 sm:mx-16 md:mx-24 text-center">
        ...
        <button className="bg-blue-600 px-8 py-4 mt-6 rounded-full font-semibold text-white hover:scale-103 hover:bg-green-400 hover:text-black transition-all cursor-pointer">
