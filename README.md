...
1. After 100% course completion:
   - AI quiz generated (Gemini API)
   - Learner takes quiz
   - If passed, content locked as complete
2. When all content complete:
   - "Generate Certificate" button appears
   - jsPDF creates custom certificate
